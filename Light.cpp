...
int Light::save_point_and_color (glm::vec3 p, glm::vec3 c) {
...
void Light::divideTriangle (int a, int b, int c, int level) {
    if (level == 0) {
...
void Light::init_model(int level) {
    ...
    all_points.emplace_back (-r3, +0.5, -r2);
#endif
    all_colors.emplace_back(0.81f, 0.81f, 0.81f);
    all_colors.emplace_back(0.89f, 0.89f, 0.89f);
    all_colors.emplace_back(1.0f, 1.0f, 1.0f);
    all_colors.emplace_back(0.91f, 0.91f, 0.89f);
